...
# false color
r.composite blue=L8_2022_G_07 green=L8_2022_G_05 red=L8_2022_G_03 output=L8_2022_G_753 --overwrite
d.mon wx0
d.rast L8_2022_G_753
...
# First, we are going to generate some training pixels from an older land cover classification:
r.random input=L8_2022_cluster_classes seed=100 npoints=1000 raster=L8_2022_G_classes_roi --overwrite
# Next, we create the imagery group with all Landsat-8 OLI/TIRS bands:
